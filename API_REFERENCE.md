...
```json
{
  "pages": ["http://localhost:8080/proxy/mangadex/e199f8e6-4eb4-4553-9b9e-0e3f2d7e7c5d/x1-abc123.jpg", "http://localhost:8080/proxy/mangadex/e199f8e6-4eb4-4553-9b9e-0e3f2d7e7c5d/x2-def456.jpg", "http://localhost:8080/proxy/mangadex/e199f8e6-4eb4-4553-9b9e-0e3f2d7e7c5d/x3-ghi789.jpg"],
  "useProxy": true
}
```
...
export const mangaApi = {
  // Get popular manga
  getPopularManga: async (limit: number = 20, offset: number = 0, order: "asc" | "desc" = "desc", sortBy: string = "followedCount") => {
    const response = await fetch(`${BASE_URL}/manga/popular?limit=${limit}&offset=${offset}&order=${order}&sortBy=${sortBy}`);
...
async function getPopularManga(limit = 20, offset = 0) {
  try {
    const response = await fetch(`http://localhost:8080/api/manga/popular?limit=${limit}&offset=${offset}`);
